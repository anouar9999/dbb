...
const CustomButton = ({ 
  ...
  const buttonContent = (
    ...
    >
      ...
      <span className="absolute inset-0 bg-gradient-to-r from-transparent to-[#8a1b69] transition-all duration-300 ease-in-out transform -translate-x-full group-hover:translate-x-0"></span>
